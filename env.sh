...
DOCKER_HIVE_CONTAINER_WORKER_IMG=${DOCKER_HIVE_CONTAINER_WORKER_IMG:-$DOCKER_HIVE_IMG}
DOCKER_HIVE_CONTAINER_WORKER_FILE=${DOCKER_HIVE_CONTAINER_WORKER_FILE:-Dockerfile-worker}
