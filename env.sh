...
DOCKER_HIVE_BUILD_IMG=${DOCKER_HIVE_BUILD_IMG:-10.1.91.17:5000/hive3}
DOCKER_HIVE_IMG=${DOCKER_HIVE_IMG:-$DOCKER_HIVE_BUILD_IMG:latest}
DOCKER_HIVE_FILE=${DOCKER_HIVE_FILE:-Dockerfile}

DOCKER_RANGER_BUILD_IMG=10.1.91.17:5000/ranger
DOCKER_RANGER_IMG=$DOCKER_RANGER_BUILD_IMG:latest
DOCKER_RANGER_FILE=Dockerfile

DOCKER_ATS_BUILD_IMG=10.1.91.17:5000/ats-2.7.7
DOCKER_ATS_IMG=$DOCKER_ATS_BUILD_IMG:latest
