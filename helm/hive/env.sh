...
DOCKER_HIVE_CONTAINER_WORKER_IMG= {{- .Values.docker.containerWorkerImage | default .Values.docker.image}}
...
CREATE_KEYTAB_SECRET={{.Values.hive.createSecret}}   # specifies whether or not to create a Secret from key/*
